...
- Do not publish Codex-driven changes to the root documentation/landing files `README.md`, `CHANGELOG.md`, `QUICK_START.md`, `WINDOWS_README.md`, `LINUX_UNIX_README.md`, or `login_page.html` through the normal review-branch workflow unless the user explicitly asks for that repo-surface change.
