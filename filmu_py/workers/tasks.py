...
_extract_int_value = _stage_scope.extract_int_value
_resolve_item_type = _stage_scope.resolve_item_type
_extract_string_attribute = _stage_scope.extract_string_attribute
_needs_failed_metadata_repair = _stage_scope.needs_failed_metadata_repair
_build_search_query = _stage_scope.build_search_query
...
_parsed_episode_numbers_from_stream = _stage_scope.parsed_episode_numbers_from_stream
_parsed_seasons_from_stream = _stage_scope.parsed_seasons_from_stream
_parsed_episode_count_from_stream = _stage_scope.parsed_episode_count_from_stream
_partial_scope_rank_bonus = _stage_scope.partial_scope_rank_bonus
_apply_partial_scope_rank_bonus = _stage_scope.apply_partial_scope_rank_bonus
